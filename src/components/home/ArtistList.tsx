...
const artists: Artist[] = [
  ...
  { name: "Memo", location: "Paris", image: "/dancers/memo.png", explanation: "Memo est un danseur polyvalent de Paris, apprécié pour son style unique et sa pédagogie." },
  ...
  { name: "Roberto Burgos", location: "Paris", image: "/dancers/roberto_burgos.png", explanation: "Roberto Burgos est un pilier de la scène reggaeton parisienne, reconnu pour son charisme." }
];
