  ...
  return (
    <div className="container mx-auto px-4 py-24 max-w-6xl">
      ...
      <section className="text-center mb-24">
        <h1 className="text-4xl font-bold mb-4 text-[#4323FC]">À propos de l'association</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group hover:scale-105 transition-transform duration-300 cursor-pointer">
            <div className="bg-[#4323FC] rounded-2xl h-full shadow-lg overflow-hidden">
              <div className="aspect-[3/2] relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#4323FC]/60 to-transparent"></div>
              </div>
              <div className="p-6">
      ...
      <section className="mb-24">
        <h2 className="text-4xl font-bold text-center mb-16 text-[#4323FC]">L'équipe</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 text-[#4323FC]">PHILIPPE</h3>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 text-[#4323FC]">FARAH</h3>
      ...
      <section className="text-center">
        <h2 className="md:text-4xl text-2xl font-bold mb-4 text-[#4323FC]">Contactez-nous</h2>
        <div className="flex flex-row justify-center gap-4">
          <a href="tel:0670423211" className="group inline-flex items-center space-x-3 text-2xl hover:text-[#4323FC] transition-colors">
            <Phone className="h-5 w-5 text-[#4323FC] group-hover:scale-110 transition-transform" />
            <span className='text-lg'>06 70 42 32 11</span>
          </a>
          <a href="mailto:ambiance-zumba@hotmail.fr" className="group inline-flex items-center space-x-3 text-2xl hover:text-[#4323FC] transition-colors">
            <Mail className="h-5 w-5 text-[#4323FC] group-hover:scale-110 transition-transform" />
        ...
        <div className="mt-8">
          <div className="flex justify-center space-x-8">
            <a href="#" className="group flex items-center space-x-4 text-lg hover:text-[#4323FC] transition-colors p-4 rounded-xl hover:bg-white/5">
              <Facebook className="h-8 w-8 text-[#4323FC] group-hover:scale-110 transition-transform" />
            ...
            <a href="#" className="group flex items-center space-x-4 text-lg hover:text-[#4323FC] transition-colors p-4 rounded-xl hover:bg-white/5">
              <Instagram className="h-8 w-8 text-[#4323FC] group-hover:scale-110 transition-transform" />
              <div className="text-left">
