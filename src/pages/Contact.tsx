    ...
    <Layout>
      <div className="container mx-auto px-4 py-24 max-w-6xl">
        ...
        <section className="text-center mb-24">
          <h1 className={`text-4xl font-bold mb-4 text-[${colors.text.primary}]`}>À propos de l'association</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="group hover:scale-105 transition-transform duration-300 cursor-pointer ">
              <div className={`bg-[${colors.text.primary}] rounded-2xl h-full shadow-lg overflow-hidden`}>
                <div className="aspect-[3/2] relative">
                  ...
                  />
                  <div className={`absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[${colors.text.primary}]/90 via-[${colors.text.primary}]/40 to-transparent`}></div>
                </div>
        ...
        <section className="mb-24">
          <h2 className={`text-4xl font-bold text-center mb-16 text-[${colors.text.primary}]`}>L'équipe</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h3 className={`text-2xl font-bold mb-2 text-[${colors.text.primary}]`}>PHILIPPE</h3>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h3 className={`text-2xl font-bold mb-2 text-[${colors.text.primary}]`}>FARAH</h3>
        ...
        <section className="text-center">
          <h2 className={`md:text-4xl text-2xl font-bold mb-4 text-[${colors.text.primary}]`}>Contactez-nous</h2>
          <div className="flex flex-row justify-center gap-4">
            <a href="tel:0670423211" className={`group inline-flex items-center space-x-3 text-2xl hover:text-[${colors.text.primary}] transition-colors`}>
              <Phone className={`h-5 w-5 text-[${colors.text.primary}] group-hover:scale-110 transition-transform`} />
              <span className='text-lg'>06 70 42 32 11</span>
            </a>
            <a href="mailto:ambiance-zumba@hotmail.fr" className={`group inline-flex items-center space-x-3 text-2xl hover:text-[${colors.text.primary}] transition-colors`}>
              <Mail className={`h-5 w-5 text-[${colors.text.primary}] group-hover:scale-110 transition-transform`} />
          ...
          <div className="mt-8">
            <div className="flex justify-center space-x-8">
              <a href="#" className={`group flex items-center space-x-4 text-lg hover:text-[${colors.text.primary}] transition-colors p-4 rounded-xl hover:bg-white/5`}>
                <Facebook className={`h-8 w-8 text-[${colors.text.primary}] group-hover:scale-110 transition-transform`} />
              ...
              <a href="#" className={`group flex items-center space-x-4 text-lg hover:text-[${colors.text.primary}] transition-colors p-4 rounded-xl hover:bg-white/5`}>
                <Instagram className={`h-8 w-8 text-[${colors.text.primary}] group-hover:scale-110 transition-transform`} />
                <div className="text-left">
