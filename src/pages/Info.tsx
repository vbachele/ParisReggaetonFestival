  ...
  return (
    <Layout>
      ...
      <div className="relative w-full">
        {/* Desktop Image */}
        <div className="md:block hidden relative w-full mt-10 h-[40vh] md:h-[400px]">
          <img 
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
            <div className="container mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Informations Pratiques</h1>
              <p className="text-xl md:text-2xl text-white/90">Tout ce que vous devez savoir pour profiter du festival</p>
            </div>
          </div>
        </div>
        {/* Mobile Image */}
        <div className="md:hidden relative w-full mt-12 h-[30vh]">
          <img 
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            <h1 className="text-3xl font-bold mb-2">Informations Pratiques</h1>
            <p className="text-lg text-white/90">Tout ce que vous devez savoir</p>
          </div>
        </div>
      </div>
      ...
      <div className={`min-h-screen bg-[${colors.background.primary}]`}>
        <div className="container mx-auto px-4 py-12 md:py-24">
          <div className="max-w-4xl mx-auto space-y-12">
            {/* Adresse Section */}
            <section>
              <h2 className={`text-xl md:text-2xl font-bold mb-6 text-[${colors.text.primary}]`}>Adresse du Festival</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <a 
                  ...
                  className={`inline-flex items-center text-[${colors.text.primary}] hover:underline`}
                >
            ...
            {/* Transport Section */}
            <section>
              <h2 className={`text-xl md:text-2xl font-bold mb-6 text-[${colors.text.primary}]`}>Transport et Hébergement</h2>
            ...
            <section>
            <h2 className={`text-xl md:text-2xl font-bold mb-6 text-[${colors.text.primary}]`}>Restauration</h2>
            <div className="bg-gray-50 p-6 rounded-lg">
